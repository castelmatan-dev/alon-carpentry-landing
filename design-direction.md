...
| `--steel` | `#38566B` | כחול פלדה מחומצנת. אקסנט פונקציונלי — מספרים, פוקוס, כפתור |
| `--oak` | `#7A4E24` | עץ. **מקום אחד בלבד בעמוד: הלוגו.** נוסף 2.9.26 |

**עדכון 2.9.26 — הלוגו.** הכיוון המקורי אסר חום כטוקן לחלוטין. בסקירה עלה שהלוגו
הטיפוגרפי יצא קטן ומרוחק. התיקון: הלוגו גדל, וקיבל את הצבע היחיד בעמוד שלקוח מעולם
העץ. זה לא שובר את התזה אלא מחדד אותה — **השם של אלון הוא הסימן החם היחיד מחוץ
לתמונות.** בכל מקום אחר העמוד נשאר קריר.
...
- **מספרים ותוויות:** **מונוספייס** (`ui-monospace`). כל מספר בעמוד — השנה 2017, מספרי השלבים, "4–8 שבועות", "שנתיים" — בגופן מכונה. ככה מספרים נראים על שרטוט.
...
2. **בסקשן התהליך** — חמשת השלבים ממוספרים במונוספייס לאורך קו אנכי. השלב "ייצור" מקבל **קו מידה שמצייר את 4–8 השבועות כמרחק מדוד**. זה הרגע שבו הדימוי עובד בפועל: משך זמן מצויר כאורך. זה הדבר שיזכרו מהעמוד.
